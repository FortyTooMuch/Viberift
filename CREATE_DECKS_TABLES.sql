...
-- This creates the decks and deck_cards tables
...
DROP POLICY IF EXISTS "Users can view cards from public decks" ON deck_cards;
...
DROP POLICY IF EXISTS "Users can insert cards to their decks" ON deck_cards;
...
DROP POLICY IF EXISTS "Users can update cards in their decks" ON deck_cards;
...
DROP POLICY IF EXISTS "Users can delete cards from their decks" ON deck_cards;
...
DROP TRIGGER IF EXISTS trigger_update_deck_timestamp ON decks;
